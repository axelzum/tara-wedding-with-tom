    ...
    <>
        ...
        <div className='flex flex-col h-full items-center'>
            ...
            <div className='flex flex-col my-5 items-center w-1/2 pb-6'>
                ...
                <p className='font-quiche text-center text-lg'>{'HarMac Event Center, Downtown Cedar Rapids'}</p>
                <p className='font-quiche text-center text-lg'>{'Late Afternoon – Schedule Pending'}</p>
                <iframe
                    height='300'
                    loading='lazy'
