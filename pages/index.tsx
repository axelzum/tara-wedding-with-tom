...
export default function Home(): React.ReactElement {
    return (
        <div className='h-screen flex flex-col md:flex-row'>
            ...
            {/* Top Nav */}
            <nav className='w-full h-16 bg-marble bg-cover md:hidden'/>

            {/* Side Nav */}
            <nav className='hidden w-1/3 lg:w-1/4 xl:w-1/5 h-full bg-marble bg-cover md:flex'/>

            <div className='h-full md:w-full'>
                <h1 className='font-henriette text-3xl text-tt-green'>{'TOM & TARA'}</h1>
            </div>
        </div>
